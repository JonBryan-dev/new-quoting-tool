        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={row.home} className={`rounded-2xl border p-6 text-center ${row.home === "ZeroDisrupt heat pump" ? "bg-white border-2 border-[#4e7522]" : "bg-white border-gray-200"}`}>
                <p className="font-bold text-gray-900 mb-1">{row.home}</p>
                <p className="text-sm text-gray-500 mb-3">{row.size}</p>
                <p className="text-3xl font-bold text-[#4e7522]">{row.price}</p>
          ...
          <p className="text-center text-sm text-gray-500 mt-8">
            ...
            &middot;{" "}
            <Link href="/guides/heat-pump-cost-staffordshire-2026" className="text-[#4e7522] font-medium underline">
