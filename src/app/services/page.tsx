          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {SERVICES.map((s) => (
              <Link
                key={s.href}
                href={s.href}
                className="group bg-white border border-gray-200 rounded-2xl p-7 hover:shadow-xl hover:border-[#4e7522]/40 transition-all flex flex-col"
              >
                <div className="w-14 h-14 bg-green-50 text-[#4e7522] rounded-xl flex items-center justify-center mb-4 transition-transform group-hover:scale-110">
                  {s.icon}
                </div>
                <h2 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#4e7522] transition-colors">
                  {s.title}
                </h2>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[#4e7522] group-hover:translate-x-1 transition-transform">
