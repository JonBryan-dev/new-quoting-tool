      ...
      <section className="bg-gradient-to-br from-[#0c3560] via-[#144E82] to-[#1C834B] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-4 max-w-3xl">
            Heat pump servicing &amp;{" "}
            <span className="text-[#7ee2a8]">maintenance</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="bg-gray-50 rounded-3xl p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={item.title} className="bg-white rounded-xl border border-gray-200 p-4">
                  <div className="w-9 h-9 bg-green-50 text-[#1C834B] rounded-lg flex items-center justify-center mb-2">
                    {item.icon}
                  </div>
            ...
            <div className="mt-5 bg-white rounded-xl border border-green-200 p-4 flex gap-3">
              <ShieldCheck className="w-5 h-5 text-[#1C834B] shrink-0 mt-0.5" />
      ...
      <section className="py-14">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-sm text-gray-400 mt-4 flex items-center justify-center gap-1.5">
            ...
            <Link href="/services/heat-pump-installation" className="text-[#1C834B] underline">
