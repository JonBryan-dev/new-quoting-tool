      ...
      <section className="bg-gradient-to-br from-[#0c3560] via-[#144E82] to-[#4e7522] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-4 max-w-3xl">
            ...
            <span className="text-[#c4dd9b]">{town.name}</span>
          </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              {[
                ...
                <div key={item.title} className="bg-gray-50 rounded-xl p-4 flex gap-3">
                  <div className="w-10 h-10 bg-green-50 text-[#4e7522] rounded-lg flex items-center justify-center shrink-0">
                    {item.icon}
                  </div>
                  <div>
          ...
          <aside className="space-y-6">
            <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-2xl border border-green-100 p-6">
              ...
              <ul className="text-sm text-gray-700 space-y-2 mb-5">
                <li className="flex gap-2"><CalendarCheck className="w-4 h-4 text-[#4e7522] shrink-0 mt-0.5" /> Takes about 45 minutes</li>
                <li className="flex gap-2"><ClipboardCheck className="w-4 h-4 text-[#4e7522] shrink-0 mt-0.5" /> Fixed quote, grant applied</li>
                <li className="flex gap-2"><Leaf className="w-4 h-4 text-[#4e7522] shrink-0 mt-0.5" /> Free &amp; no obligation</li>
              </ul>
              <Link
                href="/book"
              ...
              <div className="flex flex-wrap gap-2">
                {town.nearby.map((area) => (
                  <span key={area} className="inline-flex items-center gap-1 bg-gray-50 border border-gray-200 text-gray-600 px-3 py-1.5 rounded-full text-xs font-medium">
                    <MapPin className="w-3 h-3 text-[#4e7522]" />
                    {area}
                  </span>
                ))}
              </div>
