      ...
      <section className="bg-gradient-to-br from-[#0c3560] via-[#144E82] to-[#4e7522] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-4 max-w-3xl">
            Real installs.{" "}
            <span className="text-[#c4dd9b]">Real numbers.</span>
          </h1>
          ...
          {caseStudies.length === 0 ? (
            <div className="max-w-3xl mx-auto">
              <div className="bg-gradient-to-br from-green-50 to-blue-50 border border-green-100 rounded-3xl p-8 sm:p-10 text-center mb-10">
                <div className="w-14 h-14 bg-white text-[#4e7522] rounded-xl flex items-center justify-center mx-auto mb-4 border border-green-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={item.title} className="bg-white border border-gray-200 rounded-xl p-5">
                    <div className="w-10 h-10 bg-green-50 text-[#4e7522] rounded-lg flex items-center justify-center mb-3">
                      {item.icon}
                    </div>
